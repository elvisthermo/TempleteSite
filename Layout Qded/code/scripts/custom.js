...
$( document ).ready(function() {
    ...
    //    setTimeout(function() {
    //        $('.navigation').animate({
    //            scrollTop: $(".scroll-here").offset().top -250
    //        }, 250);  
    //     }, 500 );
    //};
    
    $('.show-navigation, .hide-navigation, .navigation-background, .menu-ball-badge').click(function(){
       $('.navigation').toggleClass('active-navigation');
       $('.navigation-background').toggleClass('active-navigation-background');
        //scroll_menu();
    });
        
    $('.open-submenu').click(function(){    
        $(this).parent().find('.submenu-items').slideToggle(200); 
        $(this).find('.fa-plus').toggleClass('rotate-icon');
    });
    ...
    $('#content').on('scroll', function (event) {
        ...
        if($(this).scrollTop() > lastScrollTop){
            ...
            $('.menu-ball-badge').removeClass('menu-ball-visible');
            //down
        }else{
            $('.back-to-top-badge').addClass('back-to-top-badge-visible');
            $('.menu-ball-badge').addClass('menu-ball-visible');
            //up
        }
    ...
    if($('body').hasClass('regular-page')){     no_sidebar();     }
    ...
    function align_cover_elements(){
        ...
        $('.cover-screen').css('height', cover_height -66);
        $('.cover-screen .overlay').css('width', cover_width);
        $('.cover-screen .overlay').css('height', cover_height-66);
        ...
        $('.homepage-cover, .homepage-cover-slider').css('height', cover_height -65);
